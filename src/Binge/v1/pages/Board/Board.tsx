	...
	return <div className='board__wrapper'>
		...
		<main className='board__content'>
			<section className='board__body'>
				...
				{/* <div></div> */}
				{props.answerRevealed ? <article className='board__column'><p className='board__answer'>{props.snapshot.answer.map(line => <p className='board__answers--line'>{line}</p>)}</p></article> : <></>} 
			</section>
